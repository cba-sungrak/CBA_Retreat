...
import kr.or.sungrak.cba.cba_camp.dialog.QAPostDialog;
import kr.or.sungrak.cba.cba_camp.models.Post;
import kr.or.sungrak.cba.cba_camp.viewholder.QAViewHolder;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (CBAUtil.getRetreat(getActivity())) {
            case Tag.RETREAT_CBA:
                ...
                TextView tv = rootView.findViewById(R.id.qaInfoTextView);
