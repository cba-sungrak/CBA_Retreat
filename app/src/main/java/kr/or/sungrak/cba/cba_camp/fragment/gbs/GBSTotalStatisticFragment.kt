...
//        mGBSTotalSatisticAdapter!!.setCustomOnItemClickListener {
//            v: View?, date: String?, campusName: String ->
//            if (!campusName.equals("CBA", ignoreCase = true))
//                fragmentManager!!.beginTransaction().replace(R.id.fragment_container, AttendFragment(campusName, date)).addToBackStack(null).commit() }
    ...
    private fun getGBSTotalStatistic(date: String, navi: String) {
        ...
        val request = service.getStatisticTotalGBS(date, navi)
